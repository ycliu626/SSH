<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="../header.jsp" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <select id="articleCategory" class="form-control" name="entity.category">
        ...
        <%@include file="../admin-js.jsp" %>
            <script type="text/javascript" src="${contextPath}/resources/js/admin/article/base-article.js"></script>
