<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="../../header.jsp" %>
        ...
        <%@include file="../../admin-js.jsp" %>
            <script type="text/javascript" src="${contextPath}/resources/js/admin/exam/focused/base-focused.js"></script>
            <script type="text/html" id="myApplyTpl">
                ...
                <tr>
                    ...
                    <td> {{if info.randomQuestion==false&&info.testPaper!=null}}{{info.testPaper.title}} {{/if}}</td>
                    <td>
