<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="../../header.jsp" %>
                        ...
                        <div class="panel-body">
                            <form id="queryForm" class="form-horizontal" role="form" onsubmit="return false">
                                ...
                                <div style="font-size: 16px; margin-bottom: 30px; border-bottom: 1px solid #ffbc1c;">
                                    <span class="glyphicon glyphicon-edit"></span> <b style="margin-left: 5px;"><s:if test="entity==null">添加</s:if><s:else>修改</s:else>集中测试信息</b>
                                </div>
                                <!-- 分割线end -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control mydate" readonly="readonly"
                                        	placeholder="请选择开始时间"
											name="entity.beginTime" value="<s:date name=" entity.beginTime" format="yyyy-MM-dd"/>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-offset-2 control-label">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control mydate" readonly="readonly"
                                        placeholder="请选择结束时间"
                                          name="entity.endTime" value="<s:date name=" entity.endTime" format="yyyy-MM-dd"/>" autocomplete="on" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-offset-2 control-label">
                                ...
                                <div class="form-group" id="examtime" <s:if test="entity==null||entity.enableTimer!=true">style="display:none"</s:if> >
                                    ...
                                    <div class="col-sm-5">
                                    <div class="input-group">
                                        <input type="number" step="10" class="form-control" name="entity.examLength" value="${entity.examLength}" min="0" placeholder="请输入通过考试时长">
        ...
        <%@include file="../../admin-js.jsp" %>
            <script type="text/javascript" src="${contextPath}/resources/js/admin/exam/focused/focused-update.js"></script>
