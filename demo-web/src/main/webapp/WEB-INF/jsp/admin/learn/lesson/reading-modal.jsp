<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <div class="modal fade" id="readingModal" data-action-name="reading"  role="dialog">
        <div class="modal-dialog" style="width: 900px;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">指定阅读</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" action="reading!addOrUpdate" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea  class="form-control" name="entity.content" style="width:700px;height:200px;visibility:hidden;" id="readingContent"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
 ...
 <script>
    ...
    KindEditor.ready(function(K) {
            readingContent = K.create('textarea[id="readingContent"]', {
