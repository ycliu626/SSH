<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@include file="../../header.jsp" %>
                ...
                <%@include file="../../admin-nav.jsp" %>
                    <div class="panel panel-default" style="margin-bottom:0px;border-radius:0px;">
                        <div class="panel-body">
                            <h4 class="channel-title"><span class="glyphicon glyphicon-edit"></span><span class="desc">视频管理</span></h4>
        ...
        <%@include file="../../admin-js.jsp" %>
            <script type="text/javascript" src="${contextPath}/resources/js/admin/resource/video/base-video.js"></script>
            <script type="text/html" id="myApplyTpl">
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <td>
                          {{if info.type==0}}视频{{/if}}
                          {{if info.type==1}}精品课程{{/if}}
                          {{if info.type==2}}音频{{/if}}
                    </td>
                      <td>{{info.speaker}}</td>
