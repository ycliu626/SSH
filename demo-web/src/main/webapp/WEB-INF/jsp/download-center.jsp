...
<body>
	<div class="container">
		...
		<div class="sub-main clearfix">
			<div class="cur-position"><span>当前位置：</span><span>下载专区</span></div>
	...
	<script>
		$(function() {
			listArticle(artecleCategoryEnum.xiazai_zhuanqu);
		});
	</script>
	<script type="text/html" id="myApplyTpl">
	    {{each results as info}}
	    <tr>
	        <td><a target="_blank" href="download?fileName={{info.attachment}}">{{info.title}}</a></td>
